...
LineTemplate = """
[Post{n}Line{m}VisibilityMeasure]
Measure=String
String=#Post{n}Line{m}#
IfCondition=([Post{n}Line{m}VisibilityMeasure] = -1)
IfTrueAction=[!HideMeter Post{n}Line{m}Meter]
DynamicVariables=1
...
with open("skin.ini", "w") as fp:
    ...
    for n in range(8):
        fp.write(EntryTemplate.format(n=n))
        for m in range(6):
            fp.write(LineTemplate.format(n=n, m=m))
